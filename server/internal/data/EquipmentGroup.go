...
// Хранит группу оборудования, установленного на конкретном космическом объекте.
...
// Хранит группы оборудования космических объектов.
...
// Создает пустое хранилище групп оборудования объектов.
...
// Добавляет новую группу оборудования и назначает новый ID.
...
// Возвращает группу оборудования по ID.
...
// Возвращает группы оборудования указанного космического объекта.
...
// Удаляет все группы оборудования указанного космического объекта.
...
// Загружает группы оборудования объектов из JSON-файла.
...
// Проверяет обязательные поля группы оборудования.
