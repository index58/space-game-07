...
// CosmicObjectType хранит данные одного типа космического объекта.
...
// CosmicObjectTypes хранит типы космических объектов и быстрые индексы по уникальным полям.
...
// NewCosmicObjectTypes создаёт пустое хранилище типов космических объектов с подготовленными индексами.
...
// Add добавляет новый тип космического объекта и назначает новый ID.
...
// Get возвращает тип космического объекта по ID.
...
// Delete удаляет тип космического объекта и все его быстрые индексы.
...
// GetByTitleRu возвращает тип космического объекта по уникальному русскому названию.
...
// GetByTitleEn возвращает тип космического объекта по уникальному английскому названию.
...
// GetByAcronym возвращает тип космического объекта по уникальному акрониму.
...
// LoadFromFile загружает типы космических объектов из JSON-файла и пересобирает быстрые индексы.
...
// SaveToFile сохраняет типы космических объектов в JSON-файл без вспомогательных индексов.
...
// ensureItems подготавливает основную map типов космических объектов.
...
// validateRequiredFields проверяет обязательные поля типа космического объекта.
...
// addIndexes добавляет тип космического объекта во все быстрые индексы.
...
// deleteIndexes удаляет тип космического объекта из всех быстрых индексов.
